...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: '/goods', name: 'goods', meta: {
          requiresAuth: true, breadName: '商品列表'
        }, component: Goods
      },
      {
        path: '/orders', name: 'order', meta: {
          requiresAuth: true, breadName: '订单列表'
        }, component: Orders
      },
      {
        path: '/rights', name: 'rights', meta: {
          requiresAuth: true, breadName: '权限列表'
        }, component: Rights
      },
      {
        path: '/roles', name: 'roles', meta: {
          requiresAuth: true, breadName: '用户列表'
        }, component: Roles
      },
      {
        path: '/categories', name: 'categories', meta: {
          requiresAuth: true, breadName: '分类列表'
        }, component: Categories
      },
      {
        path: '/params', name: 'params', meta: {
          requiresAuth: true, breadName: '分类参数'
        }, component: Params
      },
      {
        path: '/reports', name: 'report', meta: {
          requiresAuth: true, breadName: '数据统计'
        }, component: Reports
      },
    ]
  },
